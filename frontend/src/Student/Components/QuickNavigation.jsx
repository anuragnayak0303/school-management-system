...
export default function QuickNavigation() {
    return (
        <>
            ...
            <NavLink to={'/school/student/notice-board'} className=' w-full lg:w-[170px] h-[12vh] bg-white rounded shadow-sm border-b-2 border-b-yellow-700 flex justify-center items-center transform transition-transform duration-300 ease-in-out hover:-translate-y-1'>
            ...
            <NavLink to={'/school/student/attendance'} className=' w-full lg:w-[170px] h-[12vh] bg-white rounded shadow-sm border-b-2 border-b-gray-700 flex justify-center items-center transform transition-transform duration-300 ease-in-out hover:-translate-y-1'>
