...
export default function ScheduleCard() {
    ...
    return (
        <div className="w-full bg-white rounded shadow-md p-5 text-gray-800 flex flex-col">
            {/* Header */}
            ...
            <div className="overflow-y-auto h-[32vh] pr-1">
                {events && events.length > 0 ? (
                    events.map((e, i) => (
                        <div
                            key={i}
                            className={`${e.category !== ("Exam" || "Event") && "hidden"}  border-l-2 border-blue-500 shadow p-3 mb-4 bg-white rounded-md`}
                        >
